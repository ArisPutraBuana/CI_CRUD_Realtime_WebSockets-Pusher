                    ...
                    success : function(data){
                        ...
                        for(i=0; i<data.length; i++){
                            html += '<tr>'+
                                    ...
                                    '<td>'+
                                        '<a href="javascript:void(0);" class="btn btn-sm btn-info item_edit mr-2" data-id="'+ data[i].product_id +'" data-name="'+ data[i].product_name +'" data-price="'+ data[i].product_price +'">Edit</a>'+
